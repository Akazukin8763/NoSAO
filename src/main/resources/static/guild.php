...
<html>
    <head>
        ...
        <script type="module">
            ...
            setModal();
            import { showGuild } from "./js/Guild/setGuild.js";
            showGuild();
        </script>
    </head>
    <body>
        <div class="Aincrad">
            ...
            <div class="container d-flex">
                <button type="button" class="fw-bold m-auto btn btn-outline-dark" style=" height: 30vh; width:50vh; background-image: url('src/image/createGuild.png');font-size: 50px;background-repeat: no-repeat;background-position: center;background-size: cover;" id="buildGuild">創建公會</button>
